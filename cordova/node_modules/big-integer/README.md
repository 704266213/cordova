...
[coveralls-url]: https://coveralls.com/github/peterolson/BigInteger.js?branch=master
[coveralls-img]: https://coveralls.com/repos/peterolson/BigInteger.js/badge.svg?branch=master&service=github
[downloads-url]: https://www.npmjs.com/package/big-integer
[downloads-img]: https://img.shields.com/npm/dm/big-integer.svg
...
[View benchmarks for this method](http://peterolson.github.com/BigInteger.js/benchmark/#Addition)
...
[View benchmarks for this method](http://peterolson.github.com/BigInteger.js/benchmark/#Division)
...
[View benchmarks for this method](http://peterolson.github.com/BigInteger.js/benchmark/#Subtraction)
...
[View benchmarks for this method](http://peterolson.github.com/BigInteger.js/benchmark/#Multiplication)
...
[View benchmarks for this method](http://peterolson.github.com/BigInteger.js/benchmark/#Exponentiation)
...
[View benchmarks for this method](http://peterolson.github.com/BigInteger.js/benchmark/#Squaring)
...
[View benchmarks for this method](http://peterolson.github.com/BigInteger.js/benchmark/#toString)
...
The unit tests are contained in the `spec/spec.js` file. You can run them locally by opening the `spec/SpecRunner.html` or file or running `npm test`. You can also [run the tests online from GitHub](http://peterolson.github.com/BigInteger.js/spec/SpecRunner.html).

There are performance benchmarks that can be viewed from the `benchmarks/index.html` page. You can [run them online from GitHub](http://peterolson.github.com/BigInteger.js/benchmark/).
